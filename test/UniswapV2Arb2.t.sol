...
import {IERC20} from "uniswapv2-periphery/contracts/interfaces/IERC20.sol";
import {IWETH} from "uniswapv2-periphery/contracts/interfaces/IWETH.sol";
import {IUniswapV2Router02} from "uniswapv2-periphery/contracts/interfaces/IUniswapV2Router02.sol";
import {
    DAI,
    WETH,
...
contract UniswapV2Arb2Test is Test {
    ...
    function setUp() public {
        ...
        IERC20(address(weth)).approve(address(uni_router), type(uint256).max);
        ...
        // Give WETH to the arb contract to cover fees
        deal(WETH, address(arb), 10000 * 1e18);
    }
